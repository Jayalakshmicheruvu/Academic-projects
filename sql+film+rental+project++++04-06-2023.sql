...
select cat.name, count(*) as most_popular_film from inventory inv inner join rental ren
 inner join film_category fc inner join category cat
on inv.inventory_id = ren.inventory_id and inv.film_id = fc.film_id 
...
select city.city, count(*) as no_of_films from inventory inner join rental
 inner join customer inner join address inner join city
on inventory.inventory_id = rental.inventory_id 
and rental.customer_id = customer.customer_id and customer.address_id = address.address_id
